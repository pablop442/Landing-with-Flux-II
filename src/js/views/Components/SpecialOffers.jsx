...
const SpecialOffers = () => {
	return (
		<div className="tab-pane fade" id="pills-offers" role="tabpanel" aria-labelledby="pills-offers-tab">
			<div className="row">
				<Card
					imgSrc={amsterdam}
					imgAlt="Amsterdam"
				...
				<Card
					...
					buttonText="249€ "
				/>
				<Card imgSrc={seville} imgAlt="Seville" title="Seville" text="3 days and 2 nights" buttonText="79€ " />
				<Card
					imgSrc={berlin}
